...
namespace HelloApp
{
    ...
    public:
        ...
        virtual void callback_sayHello(const std::string& ret)
        { throw std::runtime_error("callback_sayHello() override incorrect."); }
        virtual void callback_sayHello_exception(tars::Int32 ret)
        { throw std::runtime_error("callback_sayHello_exception() override incorrect."); }
        virtual void callback_sayHello(std::string&& ret)
        { callback_sayHello(ret); }
        ...
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            switch(r.first - __Hello_all)
            {
                case 0:
                {
                    ...
                    {
                        callback_sayHello_exception(_msg_->response->iRet);
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", getModuleName(), "sayHello", 0, _trace_param_, "");
                    }
                    ...
                    callback_sayHello(std::move(_ret));
    ...
    public:
        struct PromisesayHello: virtual public TC_HandleBase
        {
        public:
            std::string _ret;
        ...
        typedef tars::TC_AutoPtr< HelloPrxCallbackPromise::PromisesayHello > PromisesayHelloPtr;

        HelloPrxCallbackPromise(const tars::Promise< HelloPrxCallbackPromise::PromisesayHelloPtr > &promise)
        : _promise_sayHello(promise)
        {}
        
        virtual void callback_sayHello(const HelloPrxCallbackPromise::PromisesayHelloPtr &ptr)
        {
            _promise_sayHello.setValue(ptr);
        }
        virtual void callback_sayHello_exception(tars::Int32 ret)
        {
            std::string str("");
            str += "Function:sayHello_exception|Ret:";
            str += TC_Common::tostr(ret);
            _promise_sayHello.setException(tars::copyException(str, ret));
        }

    protected:
        tars::Promise< HelloPrxCallbackPromise::PromisesayHelloPtr > _promise_sayHello;
        ...
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            switch(r.first - __Hello_all)
            {
                case 0:
                {
                    ...
                    HelloPrxCallbackPromise::PromisesayHelloPtr ptr (new HelloPrxCallbackPromise::PromisesayHello());
                    ...
                    {
                        callback_sayHello_exception(tars::TARSCLIENTDECODEERR);
    ...
    public:
        ...
        std::string sayHello(const std::string & name,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, tars_moduleName(), tars_name(), "sayHello", 0, _trace_param_, "");
            }

            std::map<string, string> _mStatus;
            shared_ptr<tars::ResponsePacket> rep = tars_invoke(tars::TARSNORMAL,"sayHello", _os, context, _mStatus);
            if(pResponseContext)
            {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, tars_moduleName(), tars_name(), "sayHello", 0, _trace_param_, "");
            }

            return _ret;
        }

        void async_sayHello(HelloPrxCallbackPtr callback,const std::string &name,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(name, 1);
            std::map<string, string> _mStatus;
            ...
            tars_invoke_async(tars::TARSNORMAL,"sayHello", _os, context, _mStatus, callback);
        }
        
        tars::Future< HelloPrxCallbackPromise::PromisesayHelloPtr > promise_async_sayHello(const std::string &name,const map<string, string>& context)
        {
            tars::Promise< HelloPrxCallbackPromise::PromisesayHelloPtr > promise;
        ...
        void coro_sayHello(HelloCoroPrxCallbackPtr callback,const std::string &name,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(name, 1);
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"sayHello", _os, context, _mStatus, callback, true);
        }
    ...
    public:
        virtual ~Hello(){}
        virtual std::string sayHello(const std::string & name,tars::TarsCurrentPtr _current_) = 0;
        virtual std::string sayHello(std::string && name,tars::TarsCurrentPtr _current_) 
        { return sayHello(name, _current_); }
        static void async_response_sayHello(tars::TarsCurrentPtr _current_, const std::string &_ret)
        {
            size_t _rsp_len_ = 0;
            ...
            if (_current_->isTraced())
            {
                ...
                {
                    TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", _current_->getModuleName(), "sayHello", 0, _trace_param_, "");
                }
            }

        }
        static void async_response_push_sayHello(tars::CurrentPtr _current_, const std::string &_ret, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);

                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"sayHello", _os, _context);
            }
        }
    ...
    public:
        ...
        {
            static ::std::string __HelloApp__Hello_all[]=
            {
                "sayHello"
            };

            pair<string*, string*> r = equal_range(__HelloApp__Hello_all, __HelloApp__Hello_all+1, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __HelloApp__Hello_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", getModuleName(), "sayHello", 0, _trace_param_, "");
                    }

                    std::string _ret = sayHello(std::move(name), _current);
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", getModuleName(), "sayHello", 0, _trace_param_, "");
                        }
